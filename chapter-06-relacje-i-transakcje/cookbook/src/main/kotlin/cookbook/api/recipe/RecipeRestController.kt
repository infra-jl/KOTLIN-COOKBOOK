...
import cookbook.api.ingredient.IngredientDto
import cookbook.api.ingredient.mapToIngredientDto
...
class RecipeRestController(
    ...
    fun postRecipe(@RequestBody recipeCreateDto: RecipeCreateDto): RecipeDto {
        ...
        val ingredientNames = recipeCreateDto.ingredientNames ?: listOf()
        val recipe = recipeService.addRecipe(recipeName, ingredientNames)
    ...
    fun getIngredientsByRecipeId(@PathVariable recipeId: Int): List<IngredientDto> =
        ingredientService.getIngredientsByRecipeId(recipeId)
